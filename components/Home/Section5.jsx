  ...
  return (
    <section className="md:px-[4vw] px-[3vw] md:py-[40px] py-[25px]">
      ...
      <div className="m-auto w-fit">
        <Link href="/app">
          <button className="shadow-custom-light bg-gradient-to-br from-[#efbff6] to-[#731981] hover:bg-[#71177f] m-auto md:w-[165px] w-[125px] md:h-[50px] h-[40px] sm:text-[16px] text-[14px] md:text-[20px] rounded-[42px] text-white font-[700]  px-[14px] ">
            Get started?
          </button>
        </Link>
      </div>
